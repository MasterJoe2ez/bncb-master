...
@Component({
  ...
  providers: [SetPriceService , LogsService]
})
export class SetPriceComponent implements OnInit {
  ...
  constructor(private _itemtypeService: SetPriceService,
